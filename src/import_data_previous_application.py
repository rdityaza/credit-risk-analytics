...
file_path = 'data/previous_application.csv'
...
with engine.begin() as conn:
    ...
    df.to_sql('previous_application', con=conn, if_exists='replace', index=False, chunksize=50000)

end_time = time.time()
print(f"Berhasil! Tabel 'previous_application' sudah masuk.")
